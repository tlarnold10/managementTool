...
<div class="container">
    <div class="list">
        <h3 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Feedback</h3>
        {#each feedbackItems as item}
            ...
            <br>
        {/each}
        <h3 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">1:1 Notes</h3>
...
<div>
    <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Previous Reviews for reference</h2>
    <dl class="text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
    {#each reviews as review}
        <div class="flex flex-col pb-3">
            <!-- <dt class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">{review.reviewDate.toDateString()}</dt>-->
            <dd class="font-semibold details" style="padding:2%">{review.employeeReviewFeedback}</dd>
        </div>
    {/each}
    </dl>
</div>